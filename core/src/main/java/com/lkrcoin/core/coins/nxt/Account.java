...
//                + " existing key " + com.lkrcoin.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.lkrcoin.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.lkrcoin.core.coins.nxt.Crypto.rsDecode(com.lkrcoin.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.lkrcoin.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.lkrcoin.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.lkrcoin.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.lkrcoin.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.lkrcoin.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.lkrcoin.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
